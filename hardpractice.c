...
int main()
{
    ...
    populateProductRecord(&productRecord, productList);
 	...
 	// Add a New Product
    Product product1 = {{"Jenny", "Nescafe", 1193}, 120, 300};
...
//    Product newProduct = {{"John", "Nescafe", 1123}, 110, 220};
///    updateProduct(&productRecord, 1123, newProduct);

    // Display the updated Product Record.
//    printProductList(productRecord);
